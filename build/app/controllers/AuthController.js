...
class AuthController {
    ...
    async homePage(request, response) {
        try {
            ...
            const proficiencyFilter = request.query.proficiency || "";
            const [statistics, chartData, paginatedData] = await Promise.all([
                SUSService_1.default.getDashboardStatistics(),
                SUSService_1.default.getChartData(),
                SUSService_1.default.getPaginatedResponses(page, limit, search, genderFilter, proficiencyFilter)
            ]);
            ...
            return response.inertia("dashboard/SUSDashboard", {
                statistics: {
                    ...
                    totalKuesioner: 0,
                    grade: "F",
                    interpretation: SUSService_1.default.interpretScore(0)
                },
                chartData: {
                    scoreDistribution: {
