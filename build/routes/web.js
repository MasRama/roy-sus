...
const QuestionnaireController_1 = __importDefault(require("../app/controllers/QuestionnaireController"));
...
Route.get("/questionnaire", QuestionnaireController_1.default.userInfoPage);
Route.post("/questionnaire/user-info", QuestionnaireController_1.default.processUserInfo);
Route.get("/questionnaire/survey", QuestionnaireController_1.default.surveyPage);
Route.post("/questionnaire/submit", QuestionnaireController_1.default.submitSurvey);
Route.get("/questionnaire/result/:id", QuestionnaireController_1.default.resultPage);
Route.get("/questionnaire/thank-you", QuestionnaireController_1.default.thankYouPage);
